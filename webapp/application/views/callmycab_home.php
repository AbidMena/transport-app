...
<div class="book-scn-tab">
    ...
    <div class="container-fluid bot-tab">
        ...
        <input type="text" class="form-control" name="area"  id="area_point" placeholder="Street, Town" value="<?php if($this->session->userdata('username'))
                        {
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control third" id="pickup_address_point" name="pickup_address" placeholder="Pickup Address"><?php if($this->session->userdata('username'))
                                                           {
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="landmark" id="landmark_point" placeholder="Landmark" value="<?php if($this->session->userdata('username'))
                        {
                                                    ...
                                                    <!-- <form> -->
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1"><?php echo $lang_area; ?></label>
                                                                    <input type="text" class="form-control" id="air_area" name="air_area" value="<?php if($this->session->userdata('username'))
                                                                        {
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label><input type="checkbox" id="save_address_air"><?php echo $lang_save_address; ?> </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    value="<?php if($this->session->userdata('username')){ echo $landmark;
                                                                        }
                                                                        ?>">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="form-mn">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="hour_area"
                                                                 id="hour_area" placeholder="Street, Town" value="<?php if($this->session->userdata('username')){ echo $area;} ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"><?php echo $lang_pickup_address; ?></label>
                                                                <textarea class="form-control thirds" id="pickup_address_hour" name="hour_pickup_address" placeholder="Pickup Address"> <?php if($this->session->userdata('username')) { echo $pickaddress; } ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label><input type="checkbox" id="save_address_hour"><?php echo $lang_save_address; ?></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"><?php echo $lang_landmark; ?></label>
                                                                <input type="text" class="form-control  " name="hour_landmark" id="hour_landmark" placeholder="Landmark" value="<?php if($this->session->userdata('username')){ echo $landmark; } ?>">
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-mn setup-content" id="step-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"><?php echo $lang_area; ?></label>
                                                                <input type="text" class="form-control" id="out_area" name="out_area" placeholder="Street, Town" value="<?php if($this->session->userdata('username')){ echo $area;} ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"><?php echo $lang_pickup_address; ?></label>
                                                                <textarea class="form-control" id="out_address" name="out_address" placeholder="Pickup Address"><?php if($this->session->userdata('username')) { echo $pickaddress; } ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="checkbox">
                                                                        <label><input type="checkbox" id="save_address_out"><?php echo $lang_save_address; ?></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1"><?php echo $lang_landmark; ?></label>
                                                                <input type="text" class="form-control" id="out_land" name="out_land" placeholder="Landmark" value="<?php if($this->session->userdata('username')){ echo $landmark; } ?>">
                                                            </div>
                                                        </div>
