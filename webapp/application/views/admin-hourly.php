            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                 ...
                 $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Hourly Rental' and status='Booking' and assigned_for='0' and item_status='Completed' ORDER BY id DESC");
								?>
