               ...
               <form role="form"  method="post" id="user_reg">
                  ...
                  <div class="box-body">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control regcom" placeholder="Mobile" name="mobile" id="signup-mobile" value="<?php echo $row->mobile; ?>" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
