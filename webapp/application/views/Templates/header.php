            ...
            <div class="col-lg-9">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav nav-head nav-call" id="logged_ul">
                        <li class="active"><a href="<?php echo base_url();?>about"><span><img src="<?php echo base_url();?>assets/img/home/m-1.png"/> </span><br><?php echo $lang_about_us; ?></a></li>
                        ...
                        <li><a href="<?php echo base_url();?>contact_us"><span><img src="<?php echo base_url();?>assets/img/home/m-4.png"/> </span><br><?php echo $lang_contact; ?> </a></li>
						...
						<?php if(!$user_data){?>
						 <li id="notLogged"><a href="#" id="log_sect" class="login_now"><span><img src="<?php echo base_url();?>assets/img/home/m-5.png"/> </span><br><?php echo $lang_login_signp; ?> </a></li>
                       	<?php }else{?>
						  <li id="logged" class="active check_test"><a href="<?php echo base_url();?>account"><span><img src="<?php echo base_url();?>assets/img/home/m-1.png"/> </span><br><?php echo $user_data->username; ?></a></li>
					      <li><a href="<?php echo base_url();?>logout"  ><span><img src="<?php echo base_url();?>assets/img/home/m-5.png"/> </span><br><?php echo $lang_logout; ?> </a></li>
						  <?php }?>
                    </ul>
                </div>
            </div>
