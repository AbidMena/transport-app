              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped tbl_package tbl_package1">
                                ...
                                $query1 = $this->db->query("SELECT * FROM  bookingdetails WHERE purpose='Airport Transfer' and status='Booking' and assigned_for='0' and item_status='Completed' ORDER BY id DESC");
