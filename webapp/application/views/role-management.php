	...
	if($_GET['role'] == "1") {*/
		...
		if($role_id->num_rows == 1) {
			...
			?>
             ...
             <div class="col-sm-12 admin-roleman role_dropbox role_dropbox-scroll">
        <!--<label>Default</label>
       -->
		...
		<div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("61", $p)) { echo "checked";} ?>  type="checkbox" value="49">Wallet Details  </label></div>
		 ...
		 <label>Car</label>
     <div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("66", $p)) { echo "checked";} ?>  type="checkbox" value="66">View Details  </label></div>
		 
      <div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("67", $p)) { echo "checked";} ?>  type="checkbox" value="67">Add Car Details  </label></div>
     
      <div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("68", $p)) { echo "checked";} ?>  type="checkbox" value="68">Edit Car Details  </label></div>


 <label>Outstation Package</label>
     <div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("63", $p)) { echo "checked";} ?>  type="checkbox" value="63">View Package  </label></div>
     
      <div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("64", $p)) { echo "checked";} ?>  type="checkbox" value="64">Add Package  </label></div>
     
      <div class="checkbox"><label><input class="role_checkbox" <?php if(in_array("65", $p)) { echo "checked";} ?>  type="checkbox" value="65">Edit Package  </label></div>
