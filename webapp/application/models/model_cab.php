...
//forgot password start
 function forgetpassword($email){
     ...
     if(count($query)>0) { 
       ...
       $this->db->where('email',$email);
       $query=$this->db->update('userdetails',$password);         
           if($query)
           {
			   /*$configs = array(
					'protocol'=>'smtp',
    ...
    <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px; "> Forgot Password </div>
     </div>
     <div style="background:#fff;  float:left; width:96.3%;   border-top-right-radius: 8px; border-top-left-radius: 8px; padding:15px 12px 0 12px;  ">
    		<div style="width:100%; padding:10px 0 10px 0; float:left; color:#666261; font-size:14px; text-align:center;">Thank you for choosing our service. We are happy to serve you!!!</div>
                 ...
                 <div style="width:100%; float:left; font-size:14px; text-align:center;">Your Call MY Cab new Password is '.$rand_pwd.'</div>
            </div>
        </div></div>
        <div style="background:#fff;  float:left; width:96.3%;    border-bottom-right-radius: 8px; border-bottom-left-radius: 8px; padding:20px 12px 20px 12px;  "></div>
          ...
          $res = $this->send_mail($email,$username,$settings->smtp_username,'Forget Password',$msg);
    ...
    <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px; "> OTP Verification </div>
     ...
     <div style="background:#fff;  float:left; width:96.3%;   border-top-right-radius: 8px; border-top-left-radius: 8px; padding:15px 12px 0 12px;  ">
        ...
        <div style="background:#fff;  float:left; width:96.3%;    border-bottom-right-radius: 8px; border-bottom-left-radius: 8px; padding:20px 12px 20px 12px;  "></div>
						...
						$mail_res=$this->send_mail($email,$name,$email,$sub,$msg);
...
$pickup_area =$row1->pickup_address; 
    ...
    <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px; "> BOOKING DETAILS </div>
        ...
        * Final fare payable will include Service Tax
		 ...
		 if ($this->Model_cab->send_mail($email,$name,$email,$sub,$mailTemplate)) {
...
//print_r($row);
 ...
 //echo $from.','.$name.','.$mail.','.$sub.','.$msg;
	...
	// echo 'from'.$from.'name'.$name.'mail'.$mail.'sub'.$sub;
	// $msg ='asdasdas';
	// $mail = 'adarsh.techware@gmail.com';
...
'password'=>md5($datails_arr['password']));
  ...
  if($type=='user')
	  ...
	  {		 $this->db->select('*');
		  ...
		  $this->db->where('status', 'Processing');
			...
			// $this->db->where('item_status', 'Completed');//commeted by me
...
function update_contact_us_details($data){
  ...
  $subject ='<div style="width:660px; height:300px; margin:0 auto; background:#F7941E; padding:20px 20px 20px 20px; font-family: Century Gothic,Verdana,Geneva,sans-serif; border:solid #de851b 1px;"> <div style="width:100%; float:left; padding:0 0 10px 0;">  <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px; "> CONTACT DETAILS </div>  </div> <div style="background:#fff;  float:left; width:96.3%;   border-top-right-radius: 8px; border-top-left-radius: 8px; padding:15px 12px 0 12px;  "> <div style="width:100%; padding:10px 0 10px 0; float:left; color:#666261; font-size:14px; text-align:center;">Thank you for choosing our service. We are happy to serve you!!!</div> <div style="width:100%; float:left; padding:15px 0 15px 0; border-bottom:solid #cdcdcd 1px; border-top:solid #cdcdcd 1px;">  <div style="width:100%; float:left; font-size:14px; text-align:center;"> <div style="background:#fff;  float:left; width:96.3%;    border-bottom-right-radius: 8px; border-bottom-left-radius: 8px; padding:20px 12px 20px 12px;  "></div> </div>';
  ...
  $name=$data['name'];
  $from=$data['email'];
 $mailTemplate='<div style="width:660px; height:400px; margin:0 auto; background:#F7941E; padding:20px 20px 20px 20px; font-family: Century Gothic,Verdana,Geneva,sans-serif; border:solid #de851b 1px;"> <div style="width:100%; float:left; padding:0 0 10px 0;"> <div style="width:138px; height:73px; float:left; margin:0 0 0 20px;"> <img src="'.base_url().'assets/img/home/logo.png" alt="" /></div> <div style="width:350px; float:left; padding:25px 0 0 0; text-align:center; font-size:18px; "> CONTACT DETAILS </div> </div> <div style="background:#fff;  float:left; width:96.3%;   border-top-right-radius: 8px; border-top-left-radius: 8px; padding:15px 12px 0 12px;  "> <div style="width:100%; padding:10px 0 10px 0; float:left; color:#666261; font-size:14px; text-align:center;">Thank you for choosing our service. We are happy to serve you!!!</div> <div style="width:100%; float:left; padding:15px 0 15px 0; border-bottom:solid #cdcdcd 1px; border-top:solid #cdcdcd 1px;">  <div style="width:100%; float:left; font-size:14px; text-align:center;">'. $name.' has tried to contact you</div> </div> </div> <div style="background:#3a3a3c;     float:left; width:96.3%;  padding:5px 12px 10px 12px;"> <div style="width:100%; float:left;"> <div style="width:100%;   float:left; background:#585858; padding:15px 0 15px 0; margin:5px 0 0 0; ">  <div style="width:100%; float:left; text-align:center; color:#ffdd1a; font-size:16px;">Name:  <div style="color:#fff; font-size:14px; display:inline;">'. $name.'</div></div> </div> <div style="width:100%;   float:left; background:#585858; padding:15px 0 15px 0; margin:5px 0 0 0; ">  <div style="width:100%; float:left; text-align:center; color:#ffdd1a; font-size:16px;"> Mobile: <div style="color:#fff; font-size:14px; display:inline;">'. $data['phone'].'</div></div> </div> <div style="width:100%;   float:left; background:#585858; padding:15px 0 15px 0; margin:5px 0 0 0; ">  <div style="width:100%; float:left; text-align:center; color:#ffdd1a; font-size:16px;"> Email: <div style="color:#fff; font-size:14px; display:inline;">'. $data['email'].'</div></div> </div>  </div> <div style="width:100%;   float:left; background:#585858; padding:15px 0 15px 0; margin:5px 0 0 0; ">  <div style="width:100%; float:left; text-align:center; color:#ffdd1a; font-size:16px;"> Suggestion: <div style="color:#fff; font-size:14px; display:inline;">'. $data['message'].'</div></div>  </div> </div> </div> <div style="background:#fff;  float:left; width:96.3%;    border-bottom-right-radius: 8px; border-bottom-left-radius: 8px; padding:20px 12px 20px 12px;  "></div> </div> </div>';

  //$mailTemplate = 'dsadasdasd';
  //$subject ="sadasdasd";
	
$this->send_mail($email,$name,$from,$msg,$mailTemplate);
$this->send_mail($from,$name,$email,$msg,$subject);
...
$this->db->select('*');
		...
		$this->db->join('car_categories c', "c.car_type=a.cartype AND c.status = 'Active'");
		// $this->db->where(c.status='Active');
		 // $this->db->join('cheklist as c',"c.user_id=$user_id and c.ad_id = a.id",'left');
		$query = $this->db->get();
		// echo $this->db->last_query();
...
// $jsonResults = file_get_contents($url);
   ...
   function fetch_out_car($data){	
		...
		$result = $this->db->query("SELECT cabdetails.cartype,cabdetails.standardrate,car_categories.car_image FROM `cabdetails`  JOIN car_categories ON cabdetails.cartype = car_categories.car_type  WHERE package = '$package' AND transfertype = 'Outstation Transfer'  AND car_categories.status='Active'")->result();		
// echo $this->db->last_query();
		$new_result = array();
	...
	function fetch_air_car($data){
		...
		$result = $this->db->query("SELECT cabdetails.* ,car_categories.car_image
			FROM cabdetails LEFT JOIN car_categories ON car_categories.car_type = cabdetails.cartype WHERE timetype='$time' AND transfertype ='$tran_type' AND car_categories.status='Active' ORDER BY intailrate DESC")->result();		
// echo $this->db->last_query();
		$new_result = array();
	...
	function fetch_position($data){
		...
		function booking_point($data,$username){
			...
			$data['timetype'] = $this->time_type($data['pickup_time']);
...
function cartypess(){
  ...
  function fetch_point_cab($data){
	...
	$new_result = array();
  	...
  	$result = $this->db->query("SELECT cabdetails.*,car_categories.car_image FROM cabdetails INNER JOIN car_categories ON cabdetails.cartype = car_categories.car_type WHERE transfertype='Point to Point Transfer' AND timetype = '$timetype' AND car_categories.status='Active' $where ORDER BY intailrate ASC")->result();
  ...
  function fetch_airport_cab($data){
	...
	$new_result = array();
  	...
  	$result = $this->db->query("SELECT cabdetails.*,car_categories.car_image FROM cabdetails INNER JOIN car_categories ON cabdetails.cartype = car_categories.car_type WHERE transfertype='Airport Transfer' AND timetype = '$timetype' AND car_categories.status='Active' $where ORDER BY intailrate ASC")->result();
 ...
 function insert_address($data){
  	...
  	$user = $data['value4'];
  	$area = $data['value'];
  	$pick_add = $data['value2'];
  	$landmark = $data['value3'];
  	$this->db->select('id');
    $this->db->where('username', $user);
    $result = $this->db->get('userdetails')->row(); 
    if($result){
