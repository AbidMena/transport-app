	...
	function set_map() {
	 ...
	 $scope.getCurrentLocation = function() {
        ...
        navigator.geolocation.getCurrentPosition(function(pos) {
         ...
         var drawCoordinates = function (pick_up, drop) {
	       // alert(pick_up);
		 ...
		 var Tplaces = new google.maps.places.Autocomplete(to_el,options);
            google.maps.event.addListener(Tplaces, 'place_changed', function () {
								...
								$scope.$apply(function(){
									...
									drawCoordinates($scope.start_box.location, $scope.end_box.location);
								})      
